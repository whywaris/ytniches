    ...
    <div className="w-full max-w-md">
      <div className="bg-white border border-[#E0D9CE] rounded-[20px] p-8 shadow-sm">
        ...
        <p className="text-[#8A7F72] text-sm mb-6">
          Sign in to access your niche library
        </p>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="block text-sm font-medium text-[#1A1612]">
                Password
              </label>
              <Link
                href="/auth/reset-password"
                className="text-xs text-[#8A7F72] hover:text-[#E8402A] transition-colors"
              >
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-sm text-[#8A7F72] mt-6">
          ...
          <Link href="/auth/signup" className="text-[#E8402A] font-semibold hover:underline">
            Sign up free
          </Link>
        </p>
      </div>
